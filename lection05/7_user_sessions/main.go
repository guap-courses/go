...
// curl -v localhost:5000/api/hello

// curl -v -H "Content-Type: application/json" --data '{"Login": "vasya"}' -X POST localhost:5000/login

// curl -v --cookie "auth=vasya" localhost:5000/api/hello
